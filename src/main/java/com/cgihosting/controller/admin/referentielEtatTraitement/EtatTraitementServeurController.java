package com.cgihosting.controller.admin.referentielEtatTraitement;
...
import com.cgihosting.formulaire.admin.referentielEtatTraitementServeur.AfficherReferentielEtatTraitementServeurFormulaire;
import com.cgihosting.formulaire.admin.referentielEtatTraitementServeur.DetailsReferentielEtatTraitementServeurFormulaire;
...
public class EtatTraitementServeurController {
    ...
    @RequestMapping("/admin/afficherReferentielEtatTraitementServeur")
    String afficherReferentielEtatTraitement(@RequestParam(value = "page", required = false, defaultValue = "0") int page,
        ...
        return "admin/referentielEtatTraitementServeur/afficherReferentielEtatTraitementServeur";
    }

    @RequestMapping(value = "/admin/afficherDetailsReferentielEtatTraitementServeur", method = RequestMethod.POST)
    String affichageDetailsReferentielEtatTraitement(int identifiantEtatTraitementServeurSelect, Model model){
        ...
        return "admin/referentielEtatTraitementServeur/detailsReferentielEtatTraitementServeur";
    }


    @RequestMapping(value = "/admin/modifierReferentielEtatTraitementServeur", method = RequestMethod.POST)
    ...
    String creerEtattraitementServeur(@Valid DetailsReferentielEtatTraitementServeurFormulaire detailsReferentielEtatTraitementServeurFormulaire, Model model, BindingResult bindingResult, @RequestParam String action){
        ...
        if (action.equals(ConstantesPage.ACTION_SAUVEGARDER)) {
            ...
            if (bindingResult.hasErrors()) {
                ...
                return  "redirect:/admin/afficherReferentielEtatTraitementServeur";
