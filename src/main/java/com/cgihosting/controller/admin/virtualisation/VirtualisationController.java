package com.cgihosting.controller.admin.virtualisation;

import com.cgihosting.constantes.ConstantesAdmin;
import com.cgihosting.constantes.ConstantesPage;
import com.cgihosting.domain.JournalDTO;
import com.cgihosting.domain.TypeVirtualisationDTO;
import com.cgihosting.formulaire.admin.virtualisation.AfficherVirtualisationFormulaire;
import com.cgihosting.formulaire.admin.virtualisation.DetailsVirtualisationFormulaire;
...
public class VirtualisationController {
    ...
    String creerVirtualisation(@Valid DetailsVirtualisationFormulaire detailsVirtualisationFormulaire, Model model, BindingResult bindingResult, @RequestParam String action){
        ...
        if (action.equals(ConstantesPage.ACTION_SAUVEGARDER)) {
            ...
            if (bindingResult.hasErrors()) {
                ...
                identifiantDonneeTraitee =  gererVirtualisationService.modifierVirtualisation(detailsVirtualisationFormulaire.getTypeVirtualisationDTO());
    ...
    private AfficherVirtualisationFormulaire recupererFormulaireAfficherVirtualisation(int pageCourante, int numLigneAfficheParPage)  {
        ...
        afficherVirtualisationFormulaire.setTypeVirtualisationDTOPage(gererVirtualisationService.searchAllVirtualisationDTOPageByPage(pageCourante, numLigneAfficheParPage));
    ...
    private DetailsVirtualisationFormulaire recupererFormulaireDetailsVirtualisation(int identifiantVirtualisationSelect) {
        ...
        TypeVirtualisationDTO typeVirtualisationDTO = new TypeVirtualisationDTO();

        if (identifiantVirtualisationSelect != 0) {
            typeVirtualisationDTO = gererVirtualisationService.recupererVirtualisationById(identifiantVirtualisationSelect);

            detailsVirtualisationFormulaire.setBoutonSoumissionLabel(ConstantesPage.ADMIN_BOUTON_MODIFIER_OS);
        }
        else {

            typeVirtualisationDTO.setId(0);
        ...
        detailsVirtualisationFormulaire.setTypeVirtualisationDTO(typeVirtualisationDTO);
