...
public class ConstantesPage {
    ...
    public static final String MONCGIHOSTING_DETAILS_COMMANDE_TITRE = "Mes commandes";

    public static final String MONCGIHOSTING_AFFICHAGE_AJOUT_SERVEUR_TITRE = "Ajouter serveur";


    public static final String MONCGIHOSTING_AFFICHAGE_SERVEURS_VIRTUELS_TITRE = "Mes serveurs virtuels";

    public static final String MONCGIHOSTING_DETAIL_SERVEUR_VIRTUEL_TITRE = "Mon serveur virtuel";

    /** Noms des boutons **/

    public static final String MONCGIHOSTING_BOUTON_RETOUR_LISTE_MESSAGES = "Retour liste de messages";
    public static final String MONCGIHOSTING_BOUTON_RETOUR_LISTE_COMMANDES =  "Retour";

    public static final String MONCGIHOSTING_BOUTON_RETOUR_AJOUT_SERVEUR =  "Retour";
    public static final String MONCGIHOSTING_BOUTON_AJOUT_SERVEUR_ENREGISTRER =  "Enregistrer";

    public static final String MONCGIHOSTING_BOUTON_MODIFIER_SERVEUR_VIRTUEL = "Modifier Serveur Virtuel";
    public static final String MONCGIHOSTING_BOUTON_RETOUR_LISTE_SERVEURS_VIRTUELS = "Retour";
